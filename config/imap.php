    ...
    */
    'accounts' => [
        ...
        'default' => [// account identifier
            'host'  => env('IMAP_HOST'),
            'port'  => env('IMAP_PORT'),
            'protocol'  => env('IMAP_PROTOCOL'), //might also use imap, [pop3 or nntp (untested)]
            'encryption'    => env('IMAP_ENCRYPTION'), // Supported: false, 'ssl', 'tls', 'notls', 'starttls'
        ...
        //     'username' => env('IMAP_USERNAME', 'vijay.cs@alliancein.com'),
        //     'password' => env('IMAP_PASSWORD', 'Pass@2019'),
        //     // 'authentication' => env('IMAP_AUTHENTICATION', null),
        //     'proxy' => [
        //         'socket' => null,
        //         'request_fulluri' => false,
