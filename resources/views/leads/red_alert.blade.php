...
<div class="kt-content  kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor" id="kt_content">
                    ...
                    <div class="kt-portlet__body">
                            <div id="reports_by_agent" >
                                    <form action="{{ route('red_alert') }}" method="get" id="search_agent_reports">
                                <div class="row mb-3 mt-3">
                                        ...
                                        <div class="col-2">
                                            <a href="{{ route('red_alert') }}" id="datatable_refresh2" class="btn btn-brand btn-elevate" style="border-radius: 2px;width: 100%;margin-top: 23px;"><i class="fa fa-unto"></i> Refresh</a>
                                        </div>
                                </div>
                                    </form>
                                        ...
                                        <div class="col-sm-3 table-contents">
                                            <div class="audit_count_box kt-callout audit_count_15 kt-callout--diagonal-bg">
                                                <div class="kt-portlet__body">
                                                    <div class="kt-callout__body">
                                                        <div class="kt-callout__content">
                                                            <h3 class="kt-callout__title">Total Red Alert Calls</h3>
                                                            <p class="kt-callout__desc">
                                        ...
                                        <div class="col-sm-2 table-contents">
                                            <div class="audit_count_box kt-callout audit_count_14 kt-callout--diagonal-bg">
                                                <div class="kt-portlet__body">
                                                    <div class="kt-callout__body">
                                                        <div class="kt-callout__content">
                                                            <h3 class="kt-callout__title" style="color: #fff;">Red Alert</h3>
                                                            <p class="kt-callout__desc">
