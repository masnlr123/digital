...
<div class="kt-container kt-container--fluid  kt-grid__item kt-grid__item--fluid">
    <div class="row">
        <div class="col-md-12">
            <!--begin::Portlet-->
            <form class="kt-form" method="post" enctype="multipart/form-data" action="{{ route('update_role', $role->id) }}">
                @csrf
                <div class="kt-portlet">
                    <div class="kt-portlet__head">
                        <div class="kt-portlet__head-label">
                            ...
                            <a class="btn btn-brand btn-elevate btn-pill btn-elevate-air btn-sm" style="float: right;" href="{{ url('role/') }}"><i class="fa fa-undo"></i> Back to Roles</a>
                        </div>
                    </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group row">
                                            <label class="col-8 col-form-label">{{ $per->name }}</label>
                                            <div class="col-4">
                                                <span class="kt-switch kt-switch--outline kt-switch--icon kt-switch--info">
                                                    <label>
                                                        <input type="checkbox" name="permissions[]" @if($role->hasPermissionTo($per->name)) checked @endif value="{{ $per->name }}">
                                                        <span></span>
                                                    </label>
                                                </span>
                                            </div>
