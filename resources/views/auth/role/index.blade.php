                                ...
                                <div class="kt-portlet__head kt-portlet__head--lg">
                                    <div class="kt-portlet__head-label">
                                        ...
                                        <h3 class="kt-portlet__head-title">
                                            Roles
                                            <small>List of Recent Roles</small>
                                        </h3>
                                    </div>
                                        ...
                                        <div class="kt-portlet__head-wrapper">
                                            <div class="kt-portlet__head-actions">
                                                <button type="button" class="btn btn-brand btn-elevate btn-icon-sm lead_new_btn" data-toggle="modal" data-target="#kt_modal_6">
                                                    <i class="la la-plus"></i> New Role</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="modal fade" id="kt_modal_6" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                                <div class="modal-dialog modal-dialog-centered" role="document">
                                    <div class="modal-content">
                                        <form class="kt-form" method="post" enctype="multipart/form-data" action="{{ route('register-new-role') }}">
                                            @csrf
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="exampleModalLongTitle">New User Role</h5>
                                        ...
                                        <div class="modal-footer">
                                            <input type="submit" name="" value="Create Role" class="btn btn-primary">
                                        </div>
                                    </form>
                                    </div>
                                </div>
