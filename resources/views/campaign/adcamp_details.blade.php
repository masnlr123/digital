                ...
                <div class="kt-portlet kt-portlet--tabs">
                    ...
                    <div class="kt-portlet__body">
                        <div class="tab-content">
                            <div class="tab-pane" id="metrix" role="tabpanel">
                                @include('campaign.metrix')
                            </div>
                            <div class="tab-pane active" id="ad_campaigns" role="tabpanel">
                                @include('campaign.tabs.ad_camp_single')
                            </div>
...
@include('campaign.modal.new_milestone')
@include('campaign.modal.new_task')
@include('campaign.modal.new_subtask')
