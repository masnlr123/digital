                                ...
                                <div class="kt-portlet__head kt-portlet__head--lg">
                                    <div class="kt-portlet__head-label">
                                        ...
                                        <h3 class="kt-portlet__head-title">
                                            UTM URLs
                                            <small>List of Recent UTM URLs</small>
                                        </h3>
                                    </div>
                                <div class="kt-portlet__head-toolbar">
                                        <div class="kt-portlet__head-wrapper">
                                            <div class="kt-portlet__head-actions">
                                                <a href="{{ route('utm_create') }}" class="btn btn-brand btn-elevate btn-icon-sm">
                                    ...
                                    <table class="table table-striped table-bordered table-hover table-checkable" id="kt_table_1">
                                        <thead>
                                            <tr>
                                                ...
                                                <th title="Field #6">Source</th>
                                                <th title="Field #6">Medium</th>
                                                <th title="Field #6">Term</th>
                                                <th title="Field #6">Is Dynamic LP</th>
...
new ClipboardJS('.copy-btn');
        var table = $('#kt_table_1').DataTable({
               ...
               columns: [
                        ...
                        { data: 'is_dynamic', name: 'is_dynamic' },
