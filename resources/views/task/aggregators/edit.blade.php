...
<form class="kt-form" method="post" action="{{ route('update_aggregators', $paid_task->id) }}">
    @csrf
    {{ method_field('PUT') }}
...
@if(count($sub_task) != 0)
    ...
    <div class="col-md-6">
<!--begin::Portlet-->
<form class="kt-form" enctype="multipart/form-data" method="post" action="{{ route('update_aggregators_task', $paid_task->id) }}">
    @csrf
    {{ method_field('PUT') }}
...
<!--begin::Portlet-->
<form class="kt-form" enctype="multipart/form-data" method="post" action="{{ route('update_aggregators_sub_task', $paid_task->id) }}">
    @csrf
    {{ method_field('PUT') }}
<div class="kt-portlet">
    <div class="kt-portlet__head">
