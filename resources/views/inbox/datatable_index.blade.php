                                ...
                                <div class="kt-portlet__head kt-portlet__head--lg">
                                    <div class="kt-portlet__head-label">
                                        ...
                                        <h3 class="kt-portlet__head-title">
                                            Emails
                                            <small>List of Recent Emails</small>
                                        </h3>
                                    </div>
                                <div class="kt-portlet__head-toolbar">
                                        <div class="kt-portlet__head-wrapper">
                                            <div class="kt-portlet__head-actions">
                                                <a href="https://accounts.google.com/DisplayUnlockCaptcha" class="btn btn-danger btn-elevate btn-icon-sm" target="_blank">
                                                    <i class="flaticon2-paper-plane"></i>
                                                    Unlock Google Captcha
                                                </a>
                                                <a href="{{ route('get_email') }}" class="btn btn-brand btn-elevate btn-icon-sm" target="_blank">
...
<!-- <script src="{{asset('assets/js/dataTables.checkboxes.js')}}"></script> -->
        ...
        var table = $('#kt_table_1').DataTable({
               ...
               serverSide: true,
               pageLength: 50,
               ajax: '{{ route('email_datatables') }}',
               columns: [
                        { data: 'select_email', name: 'select_email'},
                        { data: 'date', name: 'date' },
                        { data: 'from_name', name: 'from_name' },
                        { data: 'subject', name: 'subject' },
                        { data: 'create_task', name: 'create_task' }
                        // { data: 'date', name: 'date' },
