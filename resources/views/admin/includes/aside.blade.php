                                            ...
                                            <div class="kt-widget kt-widget--user-profile-1">
                                                <div class="kt-widget__head">
                                                    <div class="kt-widget__media">
                                                        ...
                                                        <img src="{{ url(Auth::user()->photo) }}" alt="image">
                                                        @else
                                                ...
                                                <div class="kt-widget__body">
                                                    <div class="kt-widget__content">
                                                        ...
                                                        <div class="kt-widget__info">
                                                            ...
                                                            <a href="#" class="kt-widget__data">{{ Auth::user()->contact }}</a>
                                                        </div>
                                                        <div class="kt-widget__info">
                                                    ...
                                                    <div class="kt-widget__items">
                                                        <a href="{{ route('profile_overview') }}" class="kt-widget__item kt-widget__item--active">
                                                        ...
                                                        <a href="{{ route('index_task_department') }}" class="kt-widget__item" data-toggle="kt-tooltip" title="" data-placement="right" data-original-title="Coming soon...">
                                                            <span class="kt-widget__section">
                                                                <span class="kt-widget__icon">
                                                                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
                                                                        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                                        ...
                                                        <a href="{{ route('activity_types_index') }}" class="kt-widget__item">
                                                            <span class="kt-widget__section">
                                                                <span class="kt-widget__icon">
                                                                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
                                                                        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
