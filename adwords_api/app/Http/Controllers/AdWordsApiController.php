...
class AdWordsApiController extends Controller
{
    ...
    private static $REPORT_TYPE_TO_DEFAULT_SELECTED_FIELDS = [
        'CAMPAIGN_PERFORMANCE_REPORT' => [
            ...
            'CampaignName',
            'CampaignStatus',
            'AccountDescriptiveName','Impressions', 'Clicks', 'Ctr', 'Cost', 'Conversions'
        ],
        'ADGROUP_PERFORMANCE_REPORT' => [
            'AdGroupId',
            'AdGroupName',
            'AdGroupStatus',
            'CampaignId','Impressions', 'Clicks', 'Ctr', 'Cost', 'Conversions'
        ],
        'AD_PERFORMANCE_REPORT' => ['AdGroupId', 'AdGroupName', 'Id', 'AdType', 'Impressions', 'Clicks', 'Ctr', 'Cost', 'Conversions'],
        'LANDING_PAGE_REPORT' => ['AdGroupId', 'AdGroupName', 'UnexpandedFinalUrlString', 'Impressions', 'Clicks', 'Ctr', 'Cost', 'Conversions', 'ConversionRate', 'CostPerConversion', 'SpeedScore', 'ValuePerConversion', 'VideoViewRate', 'VideoViews', 'CrossDeviceConversions'],
        'ACCOUNT_PERFORMANCE_REPORT' => [
            'AccountDescriptiveName',
            'ExternalCustomerId', 'Impressions', 'Clicks', 'Ctr', 'Cost', 'Conversions'
        ],
    ];
